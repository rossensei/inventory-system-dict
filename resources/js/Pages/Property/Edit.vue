    ...
    <AppLayout>
        <template #header>
            <div class="flex items-center divide-x divide-gray-200">
                ...
                <div class="px-2">
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit property details</h2>
                </div>
            </div>
        </template>
                    ...
                    <div class="max-w-2xl w-full ml-4">
                        ...
                        <div class="mb-4 flex space-x-3">
                            <div class="w-full">
                                ...
                                <TextInput id="unit_value" type="number" step=".01" v-model="form.unit_value" class="w-full text-sm" />
